...
<title>Insert title here</title>
	...
	$(function(){
		/*展示数据的datagrid表格*/
		$("#datagrid").datagrid({
			url:'${ctx}/customerService/customerServiceManager.action?status=已归档',
			method:'get',
			fit:true,
			singleSelect:false,
			toolbar:'#toolbar',
			...
			columns:[[    
			     ...
			     {field:'assigner',title:'分配人',width:80,align:'center'},
			     {field:'assignTime',title:'分配时间',width:80,align:'center'}
			]]  
		});
...
<body>
	...
	<div id="toolbar">
		<div>
			<a class="easyui-linkbutton" href="javascript:openAllot()" iconCls="icon-add">处理</a>
		</div>
	</div>
	<!-- toolbar结束 -->
	...
	<div id="dialog"  style="width:800;height: 400;padding: 10px 20px" >
		<form action="" id="form" method="post">
			...
			<table cellspacing="8px">
				...
				<tr>
					<td>服务处理：</td>
					<td><input id="serviceDeal" required="true"  name="serviceDeal" class="easyui-validatebox" data-options="multiline:true" style="width:300px;height:60px"/></td>
				</tr>				
				<tr>
					<td>处理人：</td>
		   			<td><input id="serviceDealPeople"  name="serviceDealPeople" class="easyui-combobox" data-options="
					...
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td>处理时间：</td>
		   			<td><input type="text" readonly="true" id="serviceDealTime" name="serviceDealTime" class= "easyui-datebox" />&nbsp;<font color="red">*</font></td>
				</tr>																				
			</table>
		</form>	
	</div>
